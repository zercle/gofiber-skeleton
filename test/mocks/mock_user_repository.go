...
//
//	mockgen -source=user.go -destination=../../test/mocks/mock_user_repository.go -package=mocks
//
...
func (mr *MockUserUsecaseMockRecorder) ListUsers(ctx, limit, offset any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserUsecaseMockRecorder) RegisterUser(ctx, input any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
