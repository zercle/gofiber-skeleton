...
//
//	mockgen -source=post.go -destination=mocks/usecase.go -package=mocks
//
...
func (mr *MockPostUsecaseMockRecorder) Create(ctx, userID, threadID, content any) *gomock.Call {
...
func (mr *MockPostUsecaseMockRecorder) Delete(ctx, userID, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPostUsecaseMockRecorder) Get(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPostUsecaseMockRecorder) ListByUser(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPostUsecaseMockRecorder) Update(ctx, userID, p any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
