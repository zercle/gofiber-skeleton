...
func TestProductHandler_GetProduct(t *testing.T) {
	...
	t.Run("product not found", func(t *testing.T) {
		mockProductUseCase.EXPECT().GetProduct(productID.String()).Return(nil, domain.ErrProductNotFound)
...
func TestProductHandler_UpdateProduct(t *testing.T) {
	...
	t.Run("product not found from usecase", func(t *testing.T) {
		mockProductUseCase.EXPECT().UpdateProduct(productID.String(), productInput.Name, productInput.Description, productInput.Price, productInput.Stock, productInput.ImageURL).Return(nil, domain.ErrProductNotFound)
...
func TestProductHandler_DeleteProduct(t *testing.T) {
	...
	t.Run("product not found from usecase", func(t *testing.T) {
		mockProductUseCase.EXPECT().DeleteProduct(productID.String()).Return(domain.ErrProductNotFound)
