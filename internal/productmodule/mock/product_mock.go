...
//
//	mockgen -source=product.go -destination=./mock/product_mock.go -package=productmock
//
...
import (
	...
	productmodule "github.com/zercle/gofiber-skeleton/internal/productmodule"
...
func (m *MockProductRepository) Create(product *productmodule.Product) error {
	m.ctrl.T.Helper()
...
func (m *MockProductRepository) GetAll() ([]*productmodule.Product, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll")
	ret0, _ := ret[0].([]*productmodule.Product)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockProductRepository) GetByID(id string) (*productmodule.Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductRepository) Update(product *productmodule.Product) error {
	m.ctrl.T.Helper()
...
func (m *MockProductUseCase) CreateProduct(name, description string, price float64, stock int, imageURL string) (*productmodule.Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductUseCase) GetAllProducts() ([]*productmodule.Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductUseCase) GetProduct(id string) (*productmodule.Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductUseCase) UpdateProduct(id, name, description string, price float64, stock int, imageURL string) (*productmodule.Product, error) {
	m.ctrl.T.Helper()
