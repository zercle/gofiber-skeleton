...
func TestProductUseCase_CreateProduct(t *testing.T) {
	...
	mockRepo := productmock.NewMockProductRepository(ctrl)
	...
	testCases := []struct {
		...
		},
		{
			...
			mockSetup: func() {
				mockRepo.EXPECT().Create(gomock.Any()).DoAndReturn(func(p *productmodule.Product) error {
...
func TestProductUseCase_GetProduct(t *testing.T) {
	...
	t.Run("repository returns not found error", func(t *testing.T) {
		mockProductRepo.EXPECT().GetByID(productID).Return(nil, productmodule.ErrProductNotFound)

		product, err := usecase.GetProduct(productID)
		assert.Error(t, err)
		assert.Nil(t, product)
		assert.EqualError(t, err, productmodule.ErrProductNotFound.Error())
	})
...
func TestProductUseCase_UpdateProduct(t *testing.T) {
	...
	productID := uuid.New().String()
	originalProduct := &productmodule.Product{
		ID:          productID,
		Name:        "Original Name",
	...
	t.Run("successful product update", func(t *testing.T) {
		...
		mockProductRepo.EXPECT().Update(gomock.Any()).DoAndReturn(func(p *productmodule.Product) error {
