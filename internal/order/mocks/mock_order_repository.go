...
func (m *MockOrderRepository) DeleteOrder(ctx context.Context, id types.UUIDv7) error {
	m.ctrl.T.Helper()
...
func (m *MockOrderRepository) GetOrder(ctx context.Context, id types.UUIDv7) (*domain.Order, error) {
	m.ctrl.T.Helper()
