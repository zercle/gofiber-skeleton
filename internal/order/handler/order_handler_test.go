...
func TestOrderHandler_CreateOrder(t *testing.T) {
	...
	mockOrderUseCase := mock.NewMockOrderUseCase(ctrl)
	app := fiber.New()
	...
	t.Run("empty items in request", func(t *testing.T) {
		emptyItemsReq := CreateOrderRequest{Items: []domain.OrderItem{}}
...
func TestOrderHandler_UpdateOrderStatus(t *testing.T) {
	...
	orderID := uuid.New().String()
	updateStatusReq := UpdateOrderStatusRequest{Status: string(domain.OrderStatusShipped)}
	bodyBytes, _ := json.Marshal(updateStatusReq)

	t.Run("successful order status update", func(t *testing.T) {
		mockOrderUseCase.EXPECT().UpdateOrderStatus(orderID, domain.OrderStatusShipped).Return(nil)
	...
	t.Run("usecase returns error", func(t *testing.T) {
		mockOrderUseCase.EXPECT().UpdateOrderStatus(orderID, domain.OrderStatusShipped).Return(errors.New("invalid status"))
