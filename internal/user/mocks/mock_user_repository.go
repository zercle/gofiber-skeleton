...
func (m *MockUserRepository) DeleteUser(ctx context.Context, id types.UUIDv7) error {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) GetUser(ctx context.Context, id types.UUIDv7) (*domain.User, error) {
	m.ctrl.T.Helper()
