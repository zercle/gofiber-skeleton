...
func (m *MockUserUseCase) Register(username, password, role string) (*domain.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserUseCaseMockRecorder) Register(username, password, role interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserUseCaseMockRecorder) UpdateRole(id, role interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
