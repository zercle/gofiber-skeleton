...
func (mr *MockProductRepositoryMockRecorder) UpdateStock(id, quantity interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProductUseCaseMockRecorder) CreateProduct(name, description, price, stock, imageURL interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProductUseCaseMockRecorder) GetProduct(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProductUseCaseMockRecorder) UpdateProduct(id, name, description, price, stock, imageURL interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// UpdateStock indicates an expected call of UpdateStock.
func (mr *MockProductUseCaseMockRecorder) UpdateStock(id, quantity interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
